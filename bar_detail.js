(function () {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
        ...
        return h(d, c), d.prototype.gridDefaults = {
            ...
            var b, c;
            return this.options.horizontal ? (c = this.left, b = this.right) : (c = this.top, b = this.bottom), 1 === this.data.length ? (c + b) / 2 : c + (a - this.xmin) * this.dx
            ...
            var c;
            return c = this.options.horizontal ? "M" + this.transY(a) + "," + this.xStart + "V" + this.xEnd : "M" + this.xStart + "," + this.transY(a) + "H" + this.xEnd, this.raphael.path(c).attr("stroke", b).attr("stroke-width", this.options.goalStrokeWidth)
        }, d.prototype.drawEvent = function (a, b) {
            var c;
            return c = this.options.horizontal ? "M" + this.yStart + "," + this.transX(goal) + "H" + this.yEnd : "M" + this.transX(goal) + "," + this.yStart + "V" + this.yEnd, this.raphael.path(c).attr("stroke", b).attr("stroke-width", this.options.eventStrokeWidth)
        ...
        return h(c, a), c.prototype.init = function () {
            ...
            var b, c, d, e, f, g, h;
            for (d = this.data[a], b = "<div class='morris-hover-row-label'>" + d.label + "</div>", h = d.y, c = f = 0, g = h.length; g > f; c = ++f) e = h[c], this.options.labels[c] !== !1 && (b += "<div class='morris-hover-point' style='color: " + this.colorFor(d, c, "label") + "'>\n  " + this.options.labels[c] + ":\n  " + this.yLabelFormat(e) + "\n</div>");
            ...
            var a, b, c, d, e, f;
            for (this.seriesPoints = [], a = b = d = this.options.ykeys.length - 1; 0 >= d ? 0 >= b : b >= 0; a = 0 >= d ? ++b : --b) (this.options.trendLine !== !1 && this.options.trendLine === !0 || this.options.trendLine[a] === !0) && this._drawTrendLine(a), this._drawLineFor(a);
        ...
        }, c.prototype._drawTrendLine = function (a) {
        ...
        return h(d, c), d.prototype.init = function () {
            ...
            return h = this.options.stacked ? 1 : this.options.ykeys.length, c = this.xSize / this.options.data.length, a = (c * this.options.barSizeRatio - this.options.barGap * (h - 1)) / h, this.options.barSize && (a = Math.min(a, this.options.barSize)), l = c - a * h - this.options.barGap * (h - 1), g = l / 2, o = this.ymin <= 0 && this.ymax >= 0 ? this.transY(0) : null, this.bars = function () {
                var h, l, p, q;
                for (p = this.data, q = [], d = h = 0, l = p.length; l > h; d = ++h) i = p[d], e = 0, q.push(function () {
                    var h, l, p, q;
                    for (p = i._y, q = [], j = h = 0, l = p.length; l > h; j = ++h) n = p[j], null !== n ? (o ? (m = Math.min(n, o), b = Math.max(n, o)) : (m = n, b = this.bottom), f = this.xStart + d * c + g, this.options.stacked || (f += j * (a + this.options.barGap)), k = b - m, this.options.verticalGridCondition && this.options.verticalGridCondition(i.x) && (this.options.horizontal ? this.drawBar(this.yStart, this.xStart + d * c, this.ySize, c, this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius) : this.drawBar(this.xStart + d * c, this.yEnd, c, this.ySize, this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius)), this.options.stacked && (m -= e), this.options.horizontal ? (this.drawBar(m, f, k, a, this.colorFor(i, j, "bar"), this.options.barOpacity, this.options.barRadius), q.push(e -= k)) : (this.drawBar(f, m, a, k, this.colorFor(i, j, "bar"), this.options.barOpacity, this.options.barRadius), q.push(e += k))) : q.push(null);
                    return q
                }.call(this));
                return q
            }.call(this)
            ...
            var b, c, d, e, f, g, h, i;
            for (d = this.data[a], b = "<div class='morris-hover-row-label'>" + d.label + "</div>", i = d.y, c = g = 0, h = i.length; h > g; c = ++g) f = i[c], this.options.labels[c] !== !1 && (b += "<div class='morris-hover-point' style='color: " + this.colorFor(d, c, "label") + "'>\n  " + this.options.labels[c] + ":\n  " + this.yLabelFormat(f) + "\n</div>");
